...
/**
 * This class contains physical constants and special functions not found in the java.lang.Math class. Like the java.lang.Math class this class is final and cannot be subclassed.
 * All physical constants are in cgs units.
 * <P>
 * <B>NOTE:</B> These special functions do not necessarily use the fastest or most accurate algorithms.
 *
...
public final class SpecialFunction extends Object {
	 ...
	 *         <P>
	 *         <FONT size=2> Converted to Java from<BR>
	...
	static public double gamma(double x) throws ArithmeticException {
		...
		double P[] = { 1.60119522476751861407E-4, 1.19135147006586384913E-3, 1.04213797561761569935E-2, 4.76367800457137231464E-2, 2.07448227648435975150E-1,
				4.94214826801497100753E-1, 9.99999999999999996796E-1 };
		double Q[] = { -2.31581873324120129819E-5, 5.39605580493303397842E-4, -4.45641913851797240494E-3, 1.18139785222060435552E-2, 3.58236398605498653373E-2,
	 ...
	 * 
	 * Cephes Math Library Release 2.2: July, 1992 Copyright 1984, 1987, 1989, 1992 by Stephen L. Moshier Direct inquiries to 30 Frost Street, Cambridge, MA 02140
	 */
	...
	static public double igamc(double a, double x) throws ArithmeticException {
	...
	static public double chisq(double df, double x) throws ArithmeticException {
	...
	static public double chisqc(double df, double x) throws ArithmeticException {
	...
	static public double poissonc(int k, double x) throws ArithmeticException {
	...
	static public double erfc(double a) throws ArithmeticException {
		...
		double P[] = { 2.46196981473530512524E-10, 5.64189564831068821977E-1, 7.46321056442269912687E0, 4.86371970985681366614E1, 1.96520832956077098242E2,
				5.26445194995477358631E2, 9.34528527171957607540E2, 1.02755188689515710272E3, 5.57535335369399327526E2 };
		double Q[] = {
				// 1.0
				1.32281951154744992508E1, 8.67072140885989742329E1, 3.54937778887819891062E2, 9.75708501743205489753E2, 1.82390916687909736289E3, 2.24633760818710981792E3,
	...
	static private double polevl(double x, double coef[], int N) throws ArithmeticException {
	...
	static private double p1evl(double x, double coef[], int N) throws ArithmeticException {
	...
	static private double lgamma(double x) throws ArithmeticException {
		...
		double B[] = { -1.37825152569120859100E3, -3.88016315134637840924E4, -3.31612992738871184744E5, -1.16237097492762307383E6, -1.72173700820839662146E6,
