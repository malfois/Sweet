...
public class IntegerParameter extends Parameter<Integer> {
	...
	public IntegerParameter(Integer value) {
		super(value, IntegerRange.INFINITE, IntegerRange.INFINITE);
	}

	public IntegerParameter(Integer value, IRange<Integer> minimum, IRange<Integer> maximum) {
		super(value, minimum, maximum);
	}

	@Override
	public IParameter<Integer> copy() {
		return new IntegerParameter(this.getValue(), this.getMinimumRange().copy(), this.getMaximumRange().copy());
	}
	...
	@Override
	public IRange<Integer> getValueRange() {
		return new IntegerRange(this.value, this.minimum.getValue(), this.maximum.getValue());
	}

	@Override
	public boolean setMinimumRange(IRange<Integer> range) {
		return this.setLimits(range, this.maximum);
	}

	@Override
	public boolean setMaximumRange(IRange<Integer> range) {
		return this.setLimits(this.minimum, range);

	}

	@Override
	public boolean setLimits(IRange<Integer> minimum, IRange<Integer> maximum) {
		IRange<Integer> range = new IntegerRange(this.value);
